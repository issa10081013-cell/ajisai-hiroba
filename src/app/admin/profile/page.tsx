...
export default function AdminProfilePage() {
  ...
  const LOCATION_PRESETS = ["城南区", "早良区", "中央区", "南区", "西区", "東区", "博多区", "糸島市"];
  ...
  useEffect(() => {
    const init = async () => {
      ...
      if (provider) {
        ...
        if (provider.location && !LOCATION_PRESETS.includes(provider.location)) setLocationOther(true);
      }
      setLoading(false);
    };
    init();
        ...
        <form onSubmit={handleSave} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ backgroundColor: "white", borderRadius: "16px", padding: "16px", display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <div>
              ...
              <select
                value={locationOther ? "その他" : form.location}
                onChange={e => {
